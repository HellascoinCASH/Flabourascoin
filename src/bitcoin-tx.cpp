...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s flabourascoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  flabourascoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded flabourascoin transaction") + "\n" +
              "  flabourascoin-tx [options] -create [commands]   " + _("Create hex-encoded flabourascoin transaction") + "\n" +
              "\n";
