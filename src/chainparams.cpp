...
{
    const char* pszTimestamp = "How big does the pile have to be?";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("6ee2cc121c1b3069926ed26d1fcada57967419abcb22a31b533e82e19b2c5373");
        ...
        consensus.defaultAssumeValid = uint256S("0x6ee2cc121c1b3069926ed26d1fcada57967419abcb22a31b533e82e19b2c5373"); //1441280
        ...
        genesis = CreateGenesisBlock(1621957196, 2608067, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6ee2cc121c1b3069926ed26d1fcada57967419abcb22a31b533e82e19b2c5373"));
        assert(genesis.hashMerkleRoot == uint256S("0x4fe47befd012f55f2d97c561e256fc8631aed05c7feee859a6050da8199f7396"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.flabourascoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.flabourascointools.com");
        //vSeeds.emplace_back("dnsseed.flabourascoinpool.org");
        ...
        checkpointData = {
            {
                {  1500, uint256S("0x912f6a5a358d1a42899358c538c527d91d31646864858a930218011df479b6cb")},
                {  2500, uint256S("0x7d8b96b4f02b71d4818e1006df7a9384cf7a07054eb53d57296d59170e63f3b6")},
             	{  4000, uint256S("0x817cc1c1ebdbb2dc7ca6cb3ca98d742b363926a093b81fde1bde9221bd9790e8")},
				{  8500, uint256S("0xb445b547c5245aeec7897621e565be26cb8dacd99d25c0e9f8310f56bb6a8e45")},
				{ 17000, uint256S("0x8384758d227778dddf332d612ff9d3b7030bab1a1770a73926bfe5c3925c7fef")},
           //     { 24000, uint256S("0x")},
           //     { 48500, uint256S("0x")},
           //     { 89501, uint256S("0x")},
           //     {100000, uint256S("0x")},
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xe87ad699172cccfd1c4f9cce89b6e3177bd2e3f150053e3a316b0981b59c5c9e"); //612653
        ...
        genesis = CreateGenesisBlock(1486949366, 1376642, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe87ad699172cccfd1c4f9cce89b6e3177bd2e3f150053e3a316b0981b59c5c9e"));
        assert(genesis.hashMerkleRoot == uint256S("0x4fe47befd012f55f2d97c561e256fc8631aed05c7feee859a6050da8199f7396"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.flabourascointools.com");
        //vSeeds.emplace_back("seed-b.flabourascoin.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xcec755264ba51a1eca508d2b5428220e38d8d84820ec0dd2f66fcfb8b28c9d3d"));
        assert(genesis.hashMerkleRoot == uint256S("0x4fe47befd012f55f2d97c561e256fc8631aed05c7feee859a6050da8199f7396"));
