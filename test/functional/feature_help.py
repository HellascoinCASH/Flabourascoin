...
"""Verify that starting flabourascoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start flabourascoin with -h for help text")
        ...
        self.log.info("Start flabourascoin with -version for version information")
